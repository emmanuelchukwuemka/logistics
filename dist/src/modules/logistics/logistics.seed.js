...
exports.seedServiceData = void 0;
...
const seedServiceData = async () => {
    try {
        ...
        for (const category of categories) {
            const [cat, created] = await logistics_models_1.ServiceCategory.findOrCreate({
        ...
        for (const serviceType of serviceTypes) {
            const [type, created] = await logistics_models_1.ServiceType.findOrCreate({
...
exports.seedServiceData = seedServiceData;
